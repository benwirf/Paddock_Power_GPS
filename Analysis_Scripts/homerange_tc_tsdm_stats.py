...
def calculate_raster_stats(paddock_lyr, home_range_lyr, cibo_lyr, add_layers=False):
    raster_stats = {}
    vector_layers = {}
    ...
    if add_layers:
        project.addMapLayers([hr_50_lyr_dissolved, hr_75_lyr_dissolved, hr_95_lyr_dissolved])
